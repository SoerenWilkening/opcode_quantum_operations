...
> | `shim/cq_runtime_v2.c` | everything v1 defers: 34 fp widths, 63 `qram`, ~~11 `tape`~~, `alloc_handle`. One abort shape, macro-expanded | ~~90~~ **LANDED 2026-08-27: 96**, and `bd r3y`'s worry that the 90 was written before either population was counted turned out to be unfounded — twelve macro bodies cover all 109. **98 bodies since 2026-09-02 (PRD §15 D23): the 11 `tape` bodies moved out, into the row below; 35 bodies since PRD §15 D24 later the same day, the 63 `qram` bodies moved out into `shim/cq_runtime_qram.c` — 44 lines** | 150 |
